...
class SnmpTester(object):
    ...
    def get(self, oid):
        ...
        cmd = "snmpget {0} {1} 2>&1 | grep -v SNMPv2-PDU".format(self._snmp_config(), oid)
    ...
    def get_next(self, oid):
        cmd = "snmpgetnext {0} {1} 2>&1 | grep -v SNMPv2-PDU".format(self._snmp_config(), oid)
    ...
    def walk(self, oid):
        cmd = "snmpwalk {0} {1} 2>&1 | grep -v SNMPv2-PDU".format(self._snmp_config(), oid)
